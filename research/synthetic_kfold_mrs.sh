...
# KFOLD_ROOT="/mnt/disk1/hieupc/4gpus-Stroke-outcome-prediction-code/code/datasets/fold_nonstripped_synthetic_mask"
KFOLD_ROOT="/mnt/disk1/hieupc/4gpus-Stroke-outcome-prediction-code/code/datasets/fold_nonstripped_synthetic_mask/MRS/kfold"
...
OUTPUT_ROOT="${OUTPUT_ROOT:-$REPO_ROOT/outputs/synthetic_MRS_soop_kfold}"
...
WANDB_PROJECT="${WANDB_PROJECT:-synthetic-mrs-brainiac-soop-kfold-2752026}"
...
for fold_name in $FOLD_NAMES; do
  ...
  run_experiment "$fold_dir" "$fold_name" "gs_rankin_6isdeath" 0
  run_experiment "$fold_dir" "$fold_name" "gs_rankin_6isdeath" 1
done
