...
KFOLD_ROOT="/mnt/disk1/hieupc/4gpus-Stroke-outcome-prediction-code/code/datasets/fold_nonstripped_synthetic_mask/NIHSS/kfold"
...
OUTPUT_ROOT="${OUTPUT_ROOT:-$REPO_ROOT/outputs/synthetic_nihss_soop}"
...
WANDB_PROJECT="${WANDB_PROJECT:-synthetic-nihss-brainiac-soop-kfold-2752026}"
