...
PREPROCESSED_FOLD="${PREPROCESSED_FOLD:-/mnt/disk1/hieupc/4gpus-Stroke-outcome-prediction-code/code/datasets/fold_stripped_synthetic_mask/NIHSS}"
RAW_FOLD="${RAW_FOLD:-/mnt/disk1/hieupc/4gpus-Stroke-outcome-prediction-code/code/datasets/fold_nonstripped_synthetic_mask/NIHSS}"
...
WANDB_PROJECT="${WANDB_PROJECT:-brainiac-soop-outcome-2342026-nihss-freeze}"
...
run_experiment "$RAW_FOLD" "nihss" 0 "soop_raw_nihss_image_only"
...
# run_experiment "$PREPROCESSED_FOLD" "nihss" 0 "soop_nihss_image_only"
