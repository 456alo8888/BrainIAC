...
KFOLD_ROOT="/mnt/disk1/hieupc/4gpus-Stroke-outcome-prediction-code/code/datasets/fold_raw_trace_fullmodal_mask/MRS/kfold"
...
OUTPUT_ROOT="${OUTPUT_ROOT:-$REPO_ROOT/outputs/raw_MRS_soop_kfold}"
...
WANDB_PROJECT="${WANDB_PROJECT:-raw-mrs-brainiac-soop-kfold-2752026}"
